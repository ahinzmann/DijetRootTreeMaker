...
class DijetTreeProducer : public edm::EDAnalyzer 
{
  ...
  private:  
    ...
    std::vector<float> *ptAK4_,*jecAK4_,*etaAK4_,*rapAK4_,*phiAK4_,*massAK4_,*energyAK4_,*areaAK4_,*chfAK4_,*nhfAK4_,*phfAK4_,*elfAK4_,*mufAK4_;
    ...
    std::vector<float> *ptGenAK4_,*etaGenAK4_,*rapGenAK4_,*phiGenAK4_,*massGenAK4_,*energyGenAK4_;
    ...
    std::vector<float> *ptAK8_,*jecAK8_,*etaAK8_,*rapAK8_,*phiAK8_,*massAK8_,*energyAK8_,*areaAK8_,*chfAK8_,*nhfAK8_,*phfAK8_,*elfAK8_,*mufAK8_, *massPrunedAK8_, *massSoftDropAK8_, *dR_AK8_,*tau1AK8_,*tau2AK8_, *tau3AK8_ ;
    ...
    std::vector<float> *ptGenAK8_,*etaGenAK8_,*rapGenAK8_,*phiGenAK8_,*massGenAK8_,*energyGenAK8_;
